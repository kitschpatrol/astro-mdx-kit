 ...
 *
 * Call this before the remark plugin runs to route all internal log
 * output (debug, info, warn) through your own logging infrastructure.
 * If called without arguments, resets to a fresh default logger.
