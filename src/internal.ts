 ...
 * extensions (directive, attributes) have already been registered as separate
 * remark plugins via `updateConfig`. When set, the remark plugin skips its own
 * `this.data()` / `this.use()` registration to avoid duplicates.
 *
